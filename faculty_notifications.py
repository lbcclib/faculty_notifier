...
departments.append(Department('Biology department', 'alberto.martinezsanchez.6407@mail.linnbenton.edu', r'^(GE[0-9]|Q[1-9]|Q[1-9][0-9]|Q[12][0-9][0-9]|QH[0-9]|QK[0-9]|QL[0-9]|QM[0-9]|QP[0-9]|QR[0-9]|TP248\.1[3-9]|TP248\.[2-5]|TP248\.6[0-5])([0-9]|\.|\s).*'))
...
departments.append(Department('Chemistry department', 'alberto.martinezsanchez.6407@mail.linnbenton.edu', r'^(Q[1-9]|Q[1-9][0-9]|Q[12][0-9][0-9]|QD)([0-9]|\.|\s).*'))
...
departments.append(Department('ELA department', 'alberto.martinezsanchez.6407@mail.linnbenton.edu', r'^(LB1572|LB1576|P11[89]|P12[01]|PE110[89]|PE111[0-4]|PE1128\.A2|PE113[1-9]|PE1404|PE1449)(\.|\s).*'))
...
departments.append(Department('Sociology department', 'alberto.martinezsanchez.6407@mail.linnbenton.edu', r'^(E184|H[NQSTV][0-9]+|HM[1-9]|HM[1-9][0-9]|HM[1-9][0-9]{2})(\.|\s).*'))
