...
departments.append(Department('Ceramics Department', 'sandbej@linnbenton.edu', r'^(NK3[7-9][0-9]{2}|NK4[0-5][0-9]{2}|NK46[0-8][0-9]|NK469[0-4]|TT919|TT92[0-7])(\.|\s).*'))
...
departments.append(Department('Geology department', 'sandbej@linnbenton.edu', r'^QE[0-9]+.*')) 
...
departments.append(Department('Public Safety Office', 'sandbej@linnbenton.edu', r'^(QE53[1-9]|QE54[01])(\.|\s).*'))
departments.append(Department('Religion department', 'sandbej@linnbenton.edu', r'^(B[LMPQRSTVX][0-9]+|DS1[0-4][0-9]|KB[0-9]+)(\.|\s).*'))
